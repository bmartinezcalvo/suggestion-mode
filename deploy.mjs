...
try {
  ...
  console.log('Nothing new to commit — forcing push with empty commit.');
  execSync(`git -C ${tmp} commit --allow-empty -m "deploy ${branch} (force)"`, { stdio: 'inherit' });
}
